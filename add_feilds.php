...
while ($row = mysqli_fetch_assoc($result)){
    if(intval($row['idfeilds']) >= $id){
        $id= intval($row['idfeilds']);
        $id += 1; 
    } 
}
echo $id;
...
if(isset($_POST['submit'])) {
    ...
    if($result){
        header("Location: get_feilds.php?msg=New record created successfully");
    }
    else{
        ...
        <form enctype="multipart/form-data" action="" method="post" style="width: 50vw; min-width:300px;">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <input type="text" class="form-control" name="first_name" placeholder="Feild Of Study" />
                </div>
            </div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <input type="text" class="form-control" name="first_description" placeholder="Feild Of Study Description" />
                </div>
            </div>
